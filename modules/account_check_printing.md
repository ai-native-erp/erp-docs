---
layout: page
title: "Check Printing Base (account_check_printing)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/account_check_printing/
nav_order: 0
---
# Check Printing Base — `account_check_printing`

**Source:** [`agents/modules/generated/account_check_printing.yaml`](../../agents/modules/generated/account_check_printing.yaml) · **Wiki:** [`knowledge/modules/account_check_printing/overview.md`](../../knowledge/modules/account_check_printing/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>account_check_printing</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Check Printing Base</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">accounting</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/account_check_printing</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_check_printing"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_latam_check`](l10n_latam_check.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>print.prenumbered.checks</code></div><div class="role">defined by <code>account_check_printing</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.journal</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>account.payment</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>account.payment.method</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>account.payment.register</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>account_check_printing</code></div></div>
</div>
...
| `module.l10n_latam_check` | required_by | `agents/modules/generated/l10n_latam_check.yaml` |
...
- SME owner: [`module.account_check_printing`](../../../agents/modules/generated/account_check_printing.yaml)
- Domain: `accounting`
- Category: Accounting/Accounting
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_check_printing)
- Direct dependencies: [`account`](../account/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_latam_check`](../l10n_latam_check/overview.md)
- Impact graph: [`module:account_check_printing`](../../impact-graph.json)
