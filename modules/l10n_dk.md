---
layout: page
title: "Denmark - Accounting (l10n_dk)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_dk/
nav_order: 0
---
# Denmark - Accounting — `l10n_dk`

**Source:** [`agents/modules/generated/l10n_dk.yaml`](../../agents/modules/generated/l10n_dk.yaml) · **Wiki:** [`knowledge/modules/l10n_dk/overview.md`](../../knowledge/modules/l10n_dk/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_dk</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Denmark - Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_dk</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_dk"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_dk_audit_trail`](l10n_dk_audit_trail.md), [`l10n_dk_bookkeeping`](l10n_dk_bookkeeping.md), [`l10n_dk_fik`](l10n_dk_fik.md), [`l10n_dk_oioubl`](l10n_dk_oioubl.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.account</code></div><div class="role">extended by <code>l10n_dk</code></div></div>
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_dk</code></div></div>
<div class="model"><div class="name"><code>account.journal</code></div><div class="role">extended by <code>l10n_dk</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_dk</code></div></div>
</div>
...
| `module.l10n_dk_bookkeeping` | required_by | `agents/modules/generated/l10n_dk_bookkeeping.yaml` |
| `module.l10n_dk_fik` | required_by | `agents/modules/generated/l10n_dk_fik.yaml` |
| `module.l10n_dk_oioubl` | required_by | `agents/modules/generated/l10n_dk_oioubl.yaml` |

## Full wiki excerpt

- SME owner: [`module.l10n_dk`](../../../agents/modules/generated/l10n_dk.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_dk)
...
- Reverse dependencies: [`l10n_dk_audit_trail`](../l10n_dk_audit_trail/overview.md), [`l10n_dk_bookkeeping`](../l10n_dk_bookkeeping/overview.md), [`l10n_dk_fik`](../l10n_dk_fik/overview.md), [`l10n_dk_oioubl`](../l10n_dk_oioubl/overview.md)
- Impact graph: [`module:l10n_dk`](../../impact-graph.json)
...
- [`module.l10n_dk_bookkeeping`](../../../agents/modules/generated/l10n_dk_bookkeeping.yaml) — required_by
- [`module.l10n_dk_fik`](../../../agents/modules/generated/l10n_dk_fik.yaml) — required_by
