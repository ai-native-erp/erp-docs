---
layout: page
title: "Hungary - Accounting (l10n_hu)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_hu/
nav_order: 0
---
# Hungary - Accounting — `l10n_hu`

**Source:** [`agents/modules/generated/l10n_hu.yaml`](../../agents/modules/generated/l10n_hu.yaml) · **Wiki:** [`knowledge/modules/l10n_hu/overview.md`](../../knowledge/modules/l10n_hu/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_hu</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Hungary - Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_hu</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_hu"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_hu_edi`](l10n_hu_edi.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_hu</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_hu</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_hu</code></div></div>
</div>
...
| `module.l10n_hu_edi` | required_by | `agents/modules/generated/l10n_hu_edi.yaml` |
...
- SME owner: [`module.l10n_hu`](../../../agents/modules/generated/l10n_hu.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_hu)
- Direct dependencies: [`account`](../account/overview.md), [`base_vat`](../base_vat/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_hu_edi`](../l10n_hu_edi/overview.md)
- Impact graph: [`module:l10n_hu`](../../impact-graph.json)
