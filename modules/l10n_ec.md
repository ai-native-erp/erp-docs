---
layout: page
title: "Ecuadorian Accounting (l10n_ec)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_ec/
nav_order: 0
---
# Ecuadorian Accounting — `l10n_ec`

**Source:** [`agents/modules/generated/l10n_ec.yaml`](../../agents/modules/generated/l10n_ec.yaml) · **Wiki:** [`knowledge/modules/l10n_ec/overview.md`](../../knowledge/modules/l10n_ec/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_ec</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Ecuadorian Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_ec</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_ec"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`account`](account.md), [`account_debit_note`](account_debit_note.md), [`base`](base.md), [`base_iban`](base_iban.md), [`l10n_latam_base`](l10n_latam_base.md), [`l10n_latam_invoice_document`](l10n_latam_invoice_document.md)

## Reverse dependencies (modules that depend on this)

[`l10n_ec_stock`](l10n_ec_stock.md), [`l10n_ec_website_sale`](l10n_ec_website_sale.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>l10n_ec.sri.payment</code></div><div class="role">defined by <code>l10n_ec</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>account.journal</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>account.tax</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>account.tax.group</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>l10n_latam.document.type</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_ec</code></div></div>
</div>
...
| `module.l10n_ec_stock` | required_by | `agents/modules/generated/l10n_ec_stock.yaml` |
| `module.l10n_ec_website_sale` | required_by | `agents/modules/generated/l10n_ec_website_sale.yaml` |
| `module.l10n_it_edi` | extends_model_from | `agents/modules/generated/l10n_it_edi.yaml` |
| `module.l10n_latam_base` | depends_on | `agents/modules/generated/l10n_latam_base.yaml` |

## Full wiki excerpt

- SME owner: [`module.l10n_ec`](../../../agents/modules/generated/l10n_ec.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_ec)
- Direct dependencies: [`account`](../account/overview.md), [`account_debit_note`](../account_debit_note/overview.md), [`base`](../base/overview.md), [`base_iban`](../base_iban/overview.md), [`l10n_latam_base`](../l10n_latam_base/overview.md), [`l10n_latam_invoice_document`](../l10n_latam_invoice_document/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_ec_stock`](../l10n_ec_stock/overview.md), [`l10n_ec_website_sale`](../l10n_ec_website_sale/overview.md)
- Impact graph: [`module:l10n_ec`](../../impact-graph.json)
...
- [`module.l10n_latam_base`](../../../agents/modules/generated/l10n_latam_base.yaml) — depends_on
