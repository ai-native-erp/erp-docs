---
layout: page
title: "Spain - Facturae EDI - Administrative Centers Patch (l10n_es_edi_facturae_adm_centers)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_es_edi_facturae_adm_centers/
nav_order: 0
---
# Spain - Facturae EDI - Administrative Centers Patch — `l10n_es_edi_facturae_adm_centers`

**Source:** [`agents/modules/generated/l10n_es_edi_facturae_adm_centers.yaml`](../../agents/modules/generated/l10n_es_edi_facturae_adm_centers.yaml) · **Wiki:** [`knowledge/modules/l10n_es_edi_facturae_adm_centers/overview.md`](../../knowledge/modules/l10n_es_edi_facturae_adm_centers/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_es_edi_facturae_adm_centers</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Spain - Facturae EDI - Administrative Centers Patch</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_es_edi_facturae_adm_centers</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_es_edi_facturae_adm_centers"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_es_edi_facturae`](l10n_es_edi_facturae.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>l10n_es_edi_facturae_adm_centers.ac_role_type</code></div><div class="role">defined by <code>l10n_es_edi_facturae_adm_centers</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_es_edi_facturae_adm_centers</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_es_edi_facturae_adm_centers</code></div></div>
</div>
...
| `module.l10n_es_edi_facturae` | depends_on | `agents/modules/generated/l10n_es_edi_facturae.yaml` |
...
- SME owner: [`module.l10n_es_edi_facturae_adm_centers`](../../../agents/modules/generated/l10n_es_edi_facturae_adm_centers.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/EDI
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_es_edi_facturae_adm_centers)
- Direct dependencies: [`l10n_es_edi_facturae`](../l10n_es_edi_facturae/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: None
- Impact graph: [`module:l10n_es_edi_facturae_adm_centers`](../../impact-graph.json)
...
- [`module.l10n_es_edi_facturae`](../../../agents/modules/generated/l10n_es_edi_facturae.yaml) — depends_on
