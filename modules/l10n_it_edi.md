---
layout: page
title: "Italy - E-invoicing (l10n_it_edi)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_it_edi/
nav_order: 0
---
# Italy - E-invoicing — `l10n_it_edi`

**Source:** [`agents/modules/generated/l10n_it_edi.yaml`](../../agents/modules/generated/l10n_it_edi.yaml) · **Wiki:** [`knowledge/modules/l10n_it_edi/overview.md`](../../knowledge/modules/l10n_it_edi/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_it_edi</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Italy - E-invoicing</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_it_edi</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_it_edi"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`account_edi_proxy_client`](account_edi_proxy_client.md), [`l10n_it`](l10n_it.md)

## Reverse dependencies (modules that depend on this)

[`l10n_it_edi_doi`](l10n_it_edi_doi.md), [`l10n_it_edi_ndd`](l10n_it_edi_ndd.md), [`l10n_it_edi_sale`](l10n_it_edi_sale.md), [`l10n_it_edi_website_sale`](l10n_it_edi_website_sale.md), [`l10n_it_edi_withholding`](l10n_it_edi_withholding.md), [`l10n_it_stock_ddt`](l10n_it_stock_ddt.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>l10n_it.ddt</code></div><div class="role">defined by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">defined by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">defined by <code>l10n_it_edi</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>account.move.send</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>account_edi_proxy_client.user</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>ir.attachment</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_it_edi</code></div></div>
</div>
...
| `module.account_edi_proxy_client` | depends_on, extends_model_from, model_extended_by | `agents/modules/generated/account_edi_proxy_client.yaml` |
...
- SME owner: [`module.l10n_it_edi`](../../../agents/modules/generated/l10n_it_edi.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/EDI
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_it_edi)
- Direct dependencies: [`account_edi_proxy_client`](../account_edi_proxy_client/overview.md), [`l10n_it`](../l10n_it/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_it_edi_doi`](../l10n_it_edi_doi/overview.md), [`l10n_it_edi_ndd`](../l10n_it_edi_ndd/overview.md), [`l10n_it_edi_sale`](../l10n_it_edi_sale/overview.md), [`l10n_it_edi_website_sale`](../l10n_it_edi_website_sale/overview.md), [`l10n_it_edi_withholding`](../l10n_it_edi_withholding/overview.md), [`l10n_it_stock_ddt`](../l10n_it_stock_ddt/overview.md)
- Impact graph: [`module:l10n_it_edi`](../../impact-graph.json)
...
- Extends `res.company` — defined by [`account`](../account/overview.md), [`base`](../base/overview.md), [`l10n_sg`](../l10n_sg/overview.md), [`mail`](../mail/overview.md), [`partner_autocomplete`](../partner_autocomplete/overview.md)
- Extends `res.config.settings` — defined by [`base`](../base/overview.md)
- Extends `res.partner` — defined by [`account`](../account/overview.md), [`base`](../base/overview.md), [`crm`](../crm/overview.md), [`l10n_cl`](../l10n_cl/overview.md), [`l10n_sg`](../l10n_sg/overview.md), [`l10n_tr_nilvera`](../l10n_tr_nilvera/overview.md), [`mail`](../mail/overview.md), [`partner_autocomplete`](../partner_autocomplete/overview.md), [`phone_validation`](../phone_validation/overview.md), [`purchase`](../purchase/overview.md), [`sms`](../sms/overview.md), [`test_access_rights`](../test_access_rights/overview.md), [`website`](../website/overview.md), [`website_partner`](../website_partner/overview.md)
...
- [`module.account_edi_proxy_client`](../../../agents/modules/generated/account_edi_proxy_client.yaml) — depends_on, extends_model_from, model_extended_by
...
- [`module.l10n_it`](../../../agents/modules/generated/l10n_it.yaml) — depends_on
- [`module.l10n_it_edi_doi`](../../../agents/modules/generated/l10n_it_edi_doi.yaml) — model_extended_by, required_by
- [`module.l10n_it_edi_ndd`](../../../agents/modules/generated/l10n_it_edi_ndd.yaml) — required_by
- [`module.l10n_it_edi_sale`](../../../agents/modules/generated/l10n_it_edi_sale.yaml) — required_by
- [`module.l10n_it_edi_website_sale`](../../../agents/modules/generated/l10n_it_edi_website_sale.yaml) — required_by
- [`module.l10n_it_edi_withholding`](../../../agents/modules/generated/l10n_it_edi_withholding.yaml) — required_by
