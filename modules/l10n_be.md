---
layout: page
title: "Belgium - Accounting (l10n_be)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_be/
nav_order: 0
---
# Belgium - Accounting — `l10n_be`

**Source:** [`agents/modules/generated/l10n_be.yaml`](../../agents/modules/generated/l10n_be.yaml) · **Wiki:** [`knowledge/modules/l10n_be/overview.md`](../../knowledge/modules/l10n_be/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_be</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Belgium - Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_be</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_be"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_account_edi_ubl_cii_tests`](l10n_account_edi_ubl_cii_tests.md), [`l10n_be_pos_sale`](l10n_be_pos_sale.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_be</code></div></div>
<div class="model"><div class="name"><code>account.journal</code></div><div class="role">extended by <code>l10n_be</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_be</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_be</code></div></div>
</div>
...
- SME owner: [`module.l10n_be`](../../../agents/modules/generated/l10n_be.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_be)
...
- Reverse dependencies: [`l10n_account_edi_ubl_cii_tests`](../l10n_account_edi_ubl_cii_tests/overview.md), [`l10n_be_pos_sale`](../l10n_be_pos_sale/overview.md)
- Impact graph: [`module:l10n_be`](../../impact-graph.json)
