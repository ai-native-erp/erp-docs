---
layout: page
title: "Signup (auth_signup)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/auth_signup/
nav_order: 0
---
# Signup — `auth_signup`

**Source:** [`agents/modules/generated/auth_signup.yaml`](../../agents/modules/generated/auth_signup.yaml) · **Wiki:** [`knowledge/modules/auth_signup/overview.md`](../../knowledge/modules/auth_signup/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>auth_signup</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Signup</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">platform_core</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/auth_signup</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/auth_signup"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`base_setup`](base_setup.md), [`mail`](mail.md), [`web`](web.md)

## Reverse dependencies (modules that depend on this)

[`auth_oauth`](auth_oauth.md), [`auth_password_policy_signup`](auth_password_policy_signup.md), [`portal`](portal.md), [`survey`](survey.md), [`website`](website.md), [`website_forum`](website_forum.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>ir.http</code></div><div class="role">extended by <code>auth_signup</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>auth_signup</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>auth_signup</code></div></div>
<div class="model"><div class="name"><code>res.users</code></div><div class="role">extended by <code>auth_signup</code></div></div>
</div>
...
- SME owner: [`module.auth_signup`](../../../agents/modules/generated/auth_signup.yaml)
- Domain: `platform_core`
- Category: Hidden/Tools
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/auth_signup)
- Direct dependencies: [`base_setup`](../base_setup/overview.md), [`mail`](../mail/overview.md), [`web`](../web/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`auth_oauth`](../auth_oauth/overview.md), [`auth_password_policy_signup`](../auth_password_policy_signup/overview.md), [`portal`](../portal/overview.md), [`survey`](../survey/overview.md), [`website`](../website/overview.md), [`website_forum`](../website_forum/overview.md)
- Impact graph: [`module:auth_signup`](../../impact-graph.json)
