---
layout: page
title: "Slovak - Accounting (l10n_sk)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_sk/
nav_order: 0
---
# Slovak - Accounting — `l10n_sk`

**Source:** [`agents/modules/generated/l10n_sk.yaml`](../../agents/modules/generated/l10n_sk.yaml) · **Wiki:** [`knowledge/modules/l10n_sk/overview.md`](../../knowledge/modules/l10n_sk/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_sk</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Slovak - Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_sk</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_sk"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_sk</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_sk</code></div></div>
<div class="model"><div class="name"><code>base.document.layout</code></div><div class="role">extended by <code>l10n_sk</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_sk</code></div></div>
</div>
...
- SME owner: [`module.l10n_sk`](../../../agents/modules/generated/l10n_sk.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_sk)
...
- Impact graph: [`module:l10n_sk`](../../impact-graph.json)
