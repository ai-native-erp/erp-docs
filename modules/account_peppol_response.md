---
layout: page
title: "Peppol Business Response (account_peppol_response)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/account_peppol_response/
nav_order: 0
---
# Peppol Business Response — `account_peppol_response`

**Source:** [`agents/modules/generated/account_peppol_response.yaml`](../../agents/modules/generated/account_peppol_response.yaml) · **Wiki:** [`knowledge/modules/account_peppol_response/overview.md`](../../knowledge/modules/account_peppol_response/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>account_peppol_response</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Peppol Business Response</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">accounting</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/account_peppol_response</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_peppol_response"><code>126b5bd</code></a></div></div>
</div>
## Purpose

This module is used to send/receive responses to documents received/sent with PEPPOL
...
[`l10n_fr_pdp`](l10n_fr_pdp.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.peppol.clarification</code></div><div class="role">defined by <code>account_peppol_response</code></div></div>
<div class="model"><div class="name"><code>account.peppol.rejection.wizard</code></div><div class="role">defined by <code>account_peppol_response</code></div></div>
<div class="model"><div class="name"><code>account.peppol.response</code></div><div class="role">defined by <code>account_peppol_response</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>account_peppol_response</code></div></div>
<div class="model"><div class="name"><code>account_edi_proxy_client.user</code></div><div class="role">extended by <code>account_peppol_response</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>account_peppol_response</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>account_peppol_response</code></div></div>
</div>
...
| `module.l10n_fr_pdp` | model_extended_by, required_by | `agents/modules/generated/l10n_fr_pdp.yaml` |
...
- SME owner: [`module.account_peppol_response`](../../../agents/modules/generated/account_peppol_response.yaml)
- Domain: `accounting`
- Category: Accounting/Accounting
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_peppol_response)
- Direct dependencies: [`account_peppol`](../account_peppol/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_fr_pdp`](../l10n_fr_pdp/overview.md)
- Impact graph: [`module:account_peppol_response`](../../impact-graph.json)
...
- `account.peppol.response` — extended by [`l10n_fr_pdp`](../l10n_fr_pdp/overview.md)
...
- [`module.l10n_fr_pdp`](../../../agents/modules/generated/l10n_fr_pdp.yaml) — model_extended_by, required_by
...
- Review modules extending owned models: [`l10n_fr_pdp`](../l10n_fr_pdp/overview.md).
