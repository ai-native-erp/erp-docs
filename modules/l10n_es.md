---
layout: page
title: "Spain - Accounting (PGCE 2008) (l10n_es)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_es/
nav_order: 0
---
# Spain - Accounting (PGCE 2008) — `l10n_es`

**Source:** [`agents/modules/generated/l10n_es.yaml`](../../agents/modules/generated/l10n_es.yaml) · **Wiki:** [`knowledge/modules/l10n_es/overview.md`](../../knowledge/modules/l10n_es/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_es</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Spain - Accounting (PGCE 2008)</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_es</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_es"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`l10n_es_edi_facturae`](l10n_es_edi_facturae.md), [`l10n_es_edi_sii`](l10n_es_edi_sii.md), [`l10n_es_edi_verifactu`](l10n_es_edi_verifactu.md), [`l10n_es_modelo130`](l10n_es_modelo130.md), [`l10n_es_pos`](l10n_es_pos.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_es</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_es</code></div></div>
<div class="model"><div class="name"><code>account.tax</code></div><div class="role">extended by <code>l10n_es</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_es</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_es</code></div></div>
</div>
...
| `module.l10n_es_edi_facturae` | required_by | `agents/modules/generated/l10n_es_edi_facturae.yaml` |
| `module.l10n_es_edi_sii` | required_by | `agents/modules/generated/l10n_es_edi_sii.yaml` |
| `module.l10n_es_edi_verifactu` | required_by | `agents/modules/generated/l10n_es_edi_verifactu.yaml` |
| `module.l10n_es_modelo130` | required_by | `agents/modules/generated/l10n_es_modelo130.yaml` |

## Full wiki excerpt

- SME owner: [`module.l10n_es`](../../../agents/modules/generated/l10n_es.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_es)
...
- Reverse dependencies: [`l10n_es_edi_facturae`](../l10n_es_edi_facturae/overview.md), [`l10n_es_edi_sii`](../l10n_es_edi_sii/overview.md), [`l10n_es_edi_verifactu`](../l10n_es_edi_verifactu/overview.md), [`l10n_es_modelo130`](../l10n_es_modelo130/overview.md), [`l10n_es_pos`](../l10n_es_pos/overview.md)
- Impact graph: [`module:l10n_es`](../../impact-graph.json)
...
- [`module.l10n_es_edi_facturae`](../../../agents/modules/generated/l10n_es_edi_facturae.yaml) — required_by
- [`module.l10n_es_edi_sii`](../../../agents/modules/generated/l10n_es_edi_sii.yaml) — required_by
- [`module.l10n_es_edi_verifactu`](../../../agents/modules/generated/l10n_es_edi_verifactu.yaml) — required_by
- [`module.l10n_es_modelo130`](../../../agents/modules/generated/l10n_es_modelo130.yaml) — required_by
- [`module.l10n_es_pos`](../../../agents/modules/generated/l10n_es_pos.yaml) — required_by
