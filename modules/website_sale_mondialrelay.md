---
layout: page
title: "eCommerce Mondialrelay Delivery (website_sale_mondialrelay)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/website_sale_mondialrelay/
nav_order: 0
---
# eCommerce Mondialrelay Delivery — `website_sale_mondialrelay`

**Source:** [`agents/modules/generated/website_sale_mondialrelay.yaml`](../../agents/modules/generated/website_sale_mondialrelay.yaml) · **Wiki:** [`knowledge/modules/website_sale_mondialrelay/overview.md`](../../knowledge/modules/website_sale_mondialrelay/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>website_sale_mondialrelay</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">eCommerce Mondialrelay Delivery</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">website_ecommerce</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/website_sale_mondialrelay</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/website_sale_mondialrelay"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`delivery_mondialrelay`](delivery_mondialrelay.md), [`website_sale`](website_sale.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>website_sale_mondialrelay</code></div></div>
<div class="model"><div class="name"><code>sale.order</code></div><div class="role">extended by <code>website_sale_mondialrelay</code></div></div>
<div class="model"><div class="name"><code>website</code></div><div class="role">extended by <code>website_sale_mondialrelay</code></div></div>
</div>
...
| `module.delivery_mondialrelay` | depends_on | `agents/modules/generated/delivery_mondialrelay.yaml` |
...
- SME owner: [`module.website_sale_mondialrelay`](../../../agents/modules/generated/website_sale_mondialrelay.yaml)
- Domain: `website_ecommerce`
- Category: Website/Website
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/website_sale_mondialrelay)
- Direct dependencies: [`delivery_mondialrelay`](../delivery_mondialrelay/overview.md), [`website_sale`](../website_sale/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: None
- Impact graph: [`module:website_sale_mondialrelay`](../../impact-graph.json)
...
- [`module.delivery_mondialrelay`](../../../agents/modules/generated/delivery_mondialrelay.yaml) — depends_on
