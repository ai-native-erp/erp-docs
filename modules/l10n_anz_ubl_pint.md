---
layout: page
title: "Australia & New Zealand - UBL PINT (l10n_anz_ubl_pint)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_anz_ubl_pint/
nav_order: 0
---
# Australia & New Zealand - UBL PINT — `l10n_anz_ubl_pint`

**Source:** [`agents/modules/generated/l10n_anz_ubl_pint.yaml`](../../agents/modules/generated/l10n_anz_ubl_pint.yaml) · **Wiki:** [`knowledge/modules/l10n_anz_ubl_pint/overview.md`](../../knowledge/modules/l10n_anz_ubl_pint/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_anz_ubl_pint</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Australia & New Zealand - UBL PINT</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_anz_ubl_pint</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_anz_ubl_pint"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
<div class="model"><div class="name"><code>account.edi.xml.pint_anz</code></div><div class="role">defined by <code>l10n_anz_ubl_pint</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.edi.xml.ubl_bis3</code></div><div class="role">extended by <code>l10n_anz_ubl_pint</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_anz_ubl_pint</code></div></div>
</div>
...
- SME owner: [`module.l10n_anz_ubl_pint`](../../../agents/modules/generated/l10n_anz_ubl_pint.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/EDI
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_anz_ubl_pint)
...
- Impact graph: [`module:l10n_anz_ubl_pint`](../../impact-graph.json)
