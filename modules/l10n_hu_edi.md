---
layout: page
title: "Hungary - E-invoicing (l10n_hu_edi)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_hu_edi/
nav_order: 0
---
# Hungary - E-invoicing — `l10n_hu_edi`

**Source:** [`agents/modules/generated/l10n_hu_edi.yaml`](../../agents/modules/generated/l10n_hu_edi.yaml) · **Wiki:** [`knowledge/modules/l10n_hu_edi/overview.md`](../../knowledge/modules/l10n_hu_edi/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_hu_edi</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Hungary - E-invoicing</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_hu_edi</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_hu_edi"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`account_debit_note`](account_debit_note.md), [`base_iban`](base_iban.md), [`l10n_hu`](l10n_hu.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>l10n_hu_edi.cancellation</code></div><div class="role">defined by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>l10n_hu_edi.tax_audit_export</code></div><div class="role">defined by <code>l10n_hu_edi</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.debit.note</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.move.line</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.move.reversal</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.move.send</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>account.tax</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>product.template</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
<div class="model"><div class="name"><code>uom.uom</code></div><div class="role">extended by <code>l10n_hu_edi</code></div></div>
</div>
...
| `module.l10n_hu` | depends_on | `agents/modules/generated/l10n_hu.yaml` |
...
- SME owner: [`module.l10n_hu_edi`](../../../agents/modules/generated/l10n_hu_edi.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/EDI
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_hu_edi)
- Direct dependencies: [`account_debit_note`](../account_debit_note/overview.md), [`base_iban`](../base_iban/overview.md), [`l10n_hu`](../l10n_hu/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: None
- Impact graph: [`module:l10n_hu_edi`](../../impact-graph.json)
...
- [`module.l10n_hu`](../../../agents/modules/generated/l10n_hu.yaml) — depends_on
