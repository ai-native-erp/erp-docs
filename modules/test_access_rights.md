---
layout: page
title: "test of access rights and rules (test_access_rights)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/test_access_rights/
nav_order: 0
---
# test of access rights and rules — `test_access_rights`

**Source:** [`agents/modules/generated/test_access_rights.yaml`](../../agents/modules/generated/test_access_rights.yaml) · **Wiki:** [`knowledge/modules/test_access_rights/overview.md`](../../knowledge/modules/test_access_rights/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>test_access_rights</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">test of access rights and rules</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">platform_core</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>odoo/addons/test_access_rights</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/odoo/addons/test_access_rights"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.child</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.container</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.inherits</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.obj_categ</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.some_obj</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.ticket</code></div><div class="role">defined by <code>test_access_rights</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>test_access_rights</code></div></div>
<div class="model"><div class="name"><code>test_access_right.some_obj</code></div><div class="role">extended by <code>test_access_rights</code></div></div>
</div>
...
- SME owner: [`module.test_access_rights`](../../../agents/modules/generated/test_access_rights.yaml)
- Domain: `platform_core`
- Category: Hidden/Tests
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/odoo/addons/test_access_rights)
- Direct dependencies: None
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: None
- Impact graph: [`module:test_access_rights`](../../impact-graph.json)
