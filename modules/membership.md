...
**Source:** [`agents/modules/generated/membership.yaml`](../../agents/modules/generated/membership.yaml) · **Wiki:** [`knowledge/modules/membership/overview.md`](../../knowledge/modules/membership/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>membership</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Members</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">platform_core</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/membership</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/membership"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`website_membership`](website_membership.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>membership.invoice</code></div><div class="role">defined by <code>membership</code></div></div>
<div class="model"><div class="name"><code>membership.membership_line</code></div><div class="role">defined by <code>membership</code></div></div>
<div class="model"><div class="name"><code>report.membership</code></div><div class="role">defined by <code>membership</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>membership</code></div></div>
<div class="model"><div class="name"><code>account.move.line</code></div><div class="role">extended by <code>membership</code></div></div>
<div class="model"><div class="name"><code>product.template</code></div><div class="role">extended by <code>membership</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>membership</code></div></div>
</div>
...
- SME owner: [`module.membership`](../../../agents/modules/generated/membership.yaml)
- Domain: `platform_core`
- Category: Sales/Sales
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/membership)
- Direct dependencies: [`account`](../account/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`website_membership`](../website_membership/overview.md)
- Impact graph: [`module:membership`](../../impact-graph.json)
...
- `membership.invoice`
- `membership.membership_line` — extended by [`website_membership`](../website_membership/overview.md)
- `report.membership`
...
- [`module.website_membership`](../../../agents/modules/generated/website_membership.yaml) — model_extended_by, required_by
...
- Review modules extending owned models: [`website_membership`](../website_membership/overview.md).
