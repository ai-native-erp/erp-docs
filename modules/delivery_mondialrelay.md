---
layout: page
title: "delivery_mondialrelay (delivery_mondialrelay)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/delivery_mondialrelay/
nav_order: 0
---
# delivery_mondialrelay — `delivery_mondialrelay`

**Source:** [`agents/modules/generated/delivery_mondialrelay.yaml`](../../agents/modules/generated/delivery_mondialrelay.yaml) · **Wiki:** [`knowledge/modules/delivery_mondialrelay/overview.md`](../../knowledge/modules/delivery_mondialrelay/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>delivery_mondialrelay</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">delivery_mondialrelay</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">inventory_purchase</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/delivery_mondialrelay</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/delivery_mondialrelay"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`stock_delivery`](stock_delivery.md)

## Reverse dependencies (modules that depend on this)

[`website_sale_mondialrelay`](website_sale_mondialrelay.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>choose.delivery.carrier</code></div><div class="role">extended by <code>delivery_mondialrelay</code></div></div>
<div class="model"><div class="name"><code>delivery.carrier</code></div><div class="role">extended by <code>delivery_mondialrelay</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>delivery_mondialrelay</code></div></div>
<div class="model"><div class="name"><code>sale.order</code></div><div class="role">extended by <code>delivery_mondialrelay</code></div></div>
</div>
...
- SME owner: [`module.delivery_mondialrelay`](../../../agents/modules/generated/delivery_mondialrelay.yaml)
- Domain: `inventory_purchase`
- Category: Inventory/Delivery
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/delivery_mondialrelay)
- Direct dependencies: [`stock_delivery`](../stock_delivery/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`website_sale_mondialrelay`](../website_sale_mondialrelay/overview.md)
- Impact graph: [`module:delivery_mondialrelay`](../../impact-graph.json)
