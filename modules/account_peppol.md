---
layout: page
title: "Peppol (account_peppol)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/account_peppol/
nav_order: 0
---
# Peppol — `account_peppol`

**Source:** [`agents/modules/generated/account_peppol.yaml`](../../agents/modules/generated/account_peppol.yaml) · **Wiki:** [`knowledge/modules/account_peppol/overview.md`](../../knowledge/modules/account_peppol/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>account_peppol</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Peppol</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">accounting</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/account_peppol</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_peppol"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`account_edi_proxy_client`](account_edi_proxy_client.md), [`account_edi_ubl_cii`](account_edi_ubl_cii.md)

## Reverse dependencies (modules that depend on this)

[`account_peppol_response`](account_peppol_response.md), [`account_peppol_selfbilling`](account_peppol_selfbilling.md)

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.journal</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>account.move.send</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>account_edi_proxy_client.user</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>account_peppol</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>account_peppol</code></div></div>
</div>
...
| `module.account_peppol_response` | required_by | `agents/modules/generated/account_peppol_response.yaml` |
| `module.account_peppol_selfbilling` | required_by | `agents/modules/generated/account_peppol_selfbilling.yaml` |
...
- SME owner: [`module.account_peppol`](../../../agents/modules/generated/account_peppol.yaml)
- Domain: `accounting`
- Category: Accounting/Accounting
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/account_peppol)
- Direct dependencies: [`account_edi_proxy_client`](../account_edi_proxy_client/overview.md), [`account_edi_ubl_cii`](../account_edi_ubl_cii/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`account_peppol_response`](../account_peppol_response/overview.md), [`account_peppol_selfbilling`](../account_peppol_selfbilling/overview.md)
- Impact graph: [`module:account_peppol`](../../impact-graph.json)
...
- [`module.account_peppol_response`](../../../agents/modules/generated/account_peppol_response.yaml) — required_by
- [`module.account_peppol_selfbilling`](../../../agents/modules/generated/account_peppol_selfbilling.yaml) — required_by
