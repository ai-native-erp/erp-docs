---
layout: page
title: "Indian - Accounting (l10n_in)"
subtitle: "Odoo 17 module profile — owner, dependencies, models, learnings."
permalink: /modules/l10n_in/
nav_order: 0
---
# Indian - Accounting — `l10n_in`

**Source:** [`agents/modules/generated/l10n_in.yaml`](../../agents/modules/generated/l10n_in.yaml) · **Wiki:** [`knowledge/modules/l10n_in/overview.md`](../../knowledge/modules/l10n_in/overview.md)

<div class="meta-grid">
<div class="meta-card"><div class="k">Module</div><div class="v"><code>l10n_in</code></div></div>
<div class="meta-card"><div class="k">Title</div><div class="v">Indian - Accounting</div></div>
<div class="meta-card"><div class="k">Domain</div><div class="v">localization</div></div>
<div class="meta-card"><div class="k">Application</div><div class="v">False</div></div>
<div class="meta-card"><div class="k">License</div><div class="v">LGPL-3</div></div>
<div class="meta-card"><div class="k">Source path</div><div class="v"><code>addons/l10n_in</code></div></div>
<div class="meta-card"><div class="k">Upstream revision</div><div class="v"><a href="https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_in"><code>126b5bd</code></a></div></div>
</div>
## Purpose
...
[`account_tax_python`](account_tax_python.md), [`base_vat`](base_vat.md)

## Reverse dependencies (modules that depend on this)

[`l10n_in_edi`](l10n_in_edi.md), [`l10n_in_pos`](l10n_in_pos.md), [`l10n_in_purchase`](l10n_in_purchase.md), [`l10n_in_sale`](l10n_in_sale.md), [`l10n_in_stock`](l10n_in_stock.md), [`l10n_in_withholding`](l10n_in_withholding.md)

## Models defined by this module

<div class="model-list">
<div class="model"><div class="name"><code>l10n_in.port.code</code></div><div class="role">defined by <code>l10n_in</code></div></div>
</div>

## Models extended by this module

<div class="model-list">
<div class="model"><div class="name"><code>account.chart.template</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>account.move</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>account.tax</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>mail.message</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>product.template</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>res.company</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>res.config.settings</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>res.country.state</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>res.partner</code></div><div class="role">extended by <code>l10n_in</code></div></div>
<div class="model"><div class="name"><code>uom.uom</code></div><div class="role">extended by <code>l10n_in</code></div></div>
</div>
...
| `module.account_tax_python` | depends_on | `agents/modules/generated/account_tax_python.yaml` |
...
| `module.l10n_in_pos` | required_by | `agents/modules/generated/l10n_in_pos.yaml` |
| `module.l10n_in_purchase` | required_by | `agents/modules/generated/l10n_in_purchase.yaml` |
| `module.l10n_in_sale` | required_by | `agents/modules/generated/l10n_in_sale.yaml` |

## Full wiki excerpt

- SME owner: [`module.l10n_in`](../../../agents/modules/generated/l10n_in.yaml)
- Domain: `localization`
- Category: Accounting/Localizations/Account Charts
- Source revision: [`126b5bdd1e85`](https://github.com/odoo/odoo/tree/126b5bdd1e85771549198976f8570cd2ff167608/addons/l10n_in)
- Direct dependencies: [`account_tax_python`](../account_tax_python/overview.md), [`base_vat`](../base_vat/overview.md)
- Declared license: `LGPL-3`; architecture review: [`platform.licensing-commercial-boundaries`](../../base-platform/licensing-commercial-boundaries.md)
- Reverse dependencies: [`l10n_in_edi`](../l10n_in_edi/overview.md), [`l10n_in_pos`](../l10n_in_pos/overview.md), [`l10n_in_purchase`](../l10n_in_purchase/overview.md), [`l10n_in_sale`](../l10n_in_sale/overview.md), [`l10n_in_stock`](../l10n_in_stock/overview.md), [`l10n_in_withholding`](../l10n_in_withholding/overview.md)
- Impact graph: [`module:l10n_in`](../../impact-graph.json)
...
- Extends `res.country.state` — defined by [`base`](../base/overview.md)
...
- [`module.account_tax_python`](../../../agents/modules/generated/account_tax_python.yaml) — depends_on
...
- [`module.l10n_in_pos`](../../../agents/modules/generated/l10n_in_pos.yaml) — required_by
- [`module.l10n_in_purchase`](../../../agents/modules/generated/l10n_in_purchase.yaml) — required_by
- [`module.l10n_in_sale`](../../../agents/modules/generated/l10n_in_sale.yaml) — required_by
- [`module.l10n_in_stock`](../../../agents/modules/generated/l10n_in_stock.yaml) — required_by
- [`module.l10n_in_withholding`](../../../agents/modules/generated/l10n_in_withholding.yaml) — required_by
